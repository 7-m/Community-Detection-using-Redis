...
/**
 * program to find out the distribution of hashes of redis's hasing function i.e hash = crc16(x) % 16384
 * @author mfd
 *
 */
public class TestNewWorkerManager {
